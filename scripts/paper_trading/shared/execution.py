...
SIGNALS_FIELDS = [
    ...
    "news_gate_triggered",
    "tech_gate_triggered", "tech_gate_rsi", "tech_gate_bb", "tech_gate_reason",
    "entry_score_total", "entry_score_bb", "entry_score_rsi", "entry_score_alloc",
    "entry_score_news", "entry_score_reason", "entry_rsi", "entry_prev_ret",
