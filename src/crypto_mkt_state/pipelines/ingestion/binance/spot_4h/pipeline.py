...
from .nodes import update_binance_spot_4h_incremental
...
def create_pipeline():
    ...
    return Pipeline(
        [
            node(
                func=update_binance_spot_4h_incremental,
                inputs={
                ...
                outputs="spot_crypto_4h_updated",
                name="update_binance_spot_4h_incremental",
            )
        ]
    )